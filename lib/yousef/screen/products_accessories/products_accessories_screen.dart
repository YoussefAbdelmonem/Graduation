...
enum kindData { food, accessories, }
...
class ProductsAccessoriesScreen extends StatefulWidget {
  ...
  @override
  State<ProductsAccessoriesScreen> createState() => _ProductsAccessoriesScreenState();
}
                                                ...
                                                Positioned(
                                                  ...
                                                  async {
                                                    ...
                                                    !data?['favorite'] ?FirebaseFirestore.instance.collection('favorites')
                                                      ...
                                                      icon:!data?['favorite'] ?Icon(Icons.favorite_border,color: mainColor,) :  Icon(Icons.favorite,color: mainColor,)
